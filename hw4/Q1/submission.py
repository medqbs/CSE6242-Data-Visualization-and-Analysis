...
def author():                                                                                             
        return "zyang363" # replace gburdell3 with your Georgia Tech username.                                                                                             
                                                                                              
def gtid():                                                                                               
    return 903216108 # replace with your GT ID number      
...
class PageRank:
	...
	def run_pagerank(self, node_weights,  damping_factor=0.85, iterations=10):
		...
		for it in range(iterations):
			...
			pr_add = (1-damping_factor)*node_weights			

			pr_values = np.add(new_pr_values,pr_add)
